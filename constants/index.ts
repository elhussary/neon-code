...
export const LANGUAGE_CONFIG: LanguageConfig = {
	javascript: {
		id: 'javascript',
		label: 'JavaScript',
		logoPath: '/assets/images/languages/javascript.png',
...
console.log('Sum of numbers:', sum);`
	...
	typescript: {
		id: 'typescript',
		label: 'TypeScript',
		logoPath: '/assets/images/languages/typescript.png',
...
console.log('Sum of numbers:', math.sum());`
	...
	python: {
		id: 'python',
		label: 'Python',
		logoPath: '/assets/images/languages/python.png',
...
print(f"Sum of numbers: {numbers_sum}")`
	...
	java: {
		id: 'java',
		label: 'Java',
		logoPath: '/assets/images/languages/java.png',
  ...
  private static void printArray(int[] arr) {
	...
	go: {
		id: 'go',
		label: 'Go',
		logoPath: '/assets/images/languages/go.png',
...
func main() {
  ...
  fmt.Println("Sum of numbers:", sum)
	...
	rust: {
		id: 'rust',
		label: 'Rust',
		logoPath: '/assets/images/languages/rust.png',
	...
	cpp: {
		id: 'cpp',
		label: 'C++',
		logoPath: '/assets/images/languages/cpp.png',
...
int main() {
	...
	csharp: {
		id: 'csharp',
		label: 'C#',
		logoPath: '/assets/images/languages/csharp.png',
...
class Program {
	...
	ruby: {
		id: 'ruby',
		label: 'Ruby',
		logoPath: '/assets/images/languages/ruby.png',
...
puts "Sum of numbers: #{sum}"`
	...
	swift: {
		id: 'swift',
		label: 'Swift',
		logoPath: '/assets/images/languages/swift.png',
